if($args[0] -eq "clean"){
    ...
    rm bin/
    return
}elseif($args[0] -eq "copy_maps"){
    Write-Host "Copying maps from single player"
    cp ../hawkthorne-journey/src/maps/*.tmx src/maps/*
    cp ../hawkthorne-journey/src/images/* src/images/
    cp ../hawkthorne-journey/src/maps/*.tmx ../hawkthorne-client-lua/src/maps/*
    cp ../hawkthorne-journey/src/images/* ../hawkthorne-client-lua/src/images/
}
